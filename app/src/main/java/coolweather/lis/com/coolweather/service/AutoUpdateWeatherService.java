package coolweather.lis.com.coolweather.service;
...
public class AutoUpdateWeatherService extends Service{
    ...
    private static final String TAG = "AutoUpdateWeatherServic";

    /**
     * 定时刷新
     */
    private final int anHour = 3 * 60 * 60 * 1000; //3 小时的毫秒数,3小时刷新一次
     ...
     * 更新背景图片
     */
    private void updateWeahterBgImage(){
        ...
        HttpUtil.sendOkHttpRequest(requestBingPic, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                editor.apply();
                Log.d(TAG, "onResponse: 定时刷天气背景图片成功");
            }
            @Override
            public void onFailure(Call call, IOException e) {
                e.printStackTrace();
